...
class Test_pyqt(unittest.TestCase):
    ...
    @patch('PyQt.graphicalClient.WelcomeWindow', MockClassWelcomeWindow)
    @patch('PyQt.graphicalClient.InputInfoWindow', MockClassInputInfoWindow)
    @patch('PyQt.graphicalClient.SummaryWindow', MockClassSummaryWindow)
    @patch('PyQt.graphicalClient.ProcessingWindow', MockClassProcessingWindow)
    @patch('PyQt.graphicalClient.EndWindow', MockClassEndWindow)
